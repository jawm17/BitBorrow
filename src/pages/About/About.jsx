...
export default function About() {
    ...
    return (
        <div>
            ...
            <a href="https://github.com/jawm17/BitBorrow" target="_blank" class="button first"><button>View Source</button><span></span></a>

            <a onClick={() => navigate("/borrow")} target="_blank" class="button sec"><button>Borrow rBTC</button><span></span></a>

            <a onClick={() => open()} target="_blank" class="button third"><button>Connect</button><span></span></a>
